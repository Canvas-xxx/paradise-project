...
import { schedulExamReducer, schedulExamRejectedReducer } from './schedulExam/SchedulExamReducer'
...
export default combineReducers({
    ...
    schedul: schedulExamReducer,
    schedulReject: schedulExamRejectedReducer
})